...
def load_local_partitioned_data(client_id, iid_fraction: float, num_partitions: int):
    ...
    if os.path.exists(f'partitions/cifar10_cid{client_id}.pth'):
        torch_partition_trainset, torch_partition_testset = torch.load(f'partitions/cifar10_cid{client_id}.pth')
    ...
    torch.save((torch_partition_trainset, torch_partition_testset), f'partitions/cifar10_cid{client_id}.pth')
    return torch_partition_trainset, torch_partition_testset
