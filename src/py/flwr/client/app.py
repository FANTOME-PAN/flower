...
from flwr.client.sa_client_wrappers import LightSecAggWrapper, SecAggPlusWrapper
...
def start_client(
    *,
    ...
    sa_protocol: Optional[str]=None,
    sa_wrapper: Optional[Callable[[Client], SAClientWrapper]]=None,
) -> None:
